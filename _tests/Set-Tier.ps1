...
# v4.4.0 ROOT CLEANUP: our ini lives in 010-SC4UIScale, and the Plugins
# root now carries the DLL and nothing else.
$ini = Join-Path $plug "010-SC4UIScale\SC4UIScale.ini"
