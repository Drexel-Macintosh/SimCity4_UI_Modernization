...
-- create a generator that creates recycle trucks at the edge of the lot.
generator.recycle_out = 
{
      automata = { "recycle_truck" },						-- create recycle trucks
...
occupant_group.recycle =   ---- this is the building group name
{
	 group_id = "0x1404",			-- this should be a GUID defined in ingred.ini's "occupant groups" value map - building group number
