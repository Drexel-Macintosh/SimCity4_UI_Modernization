...
dofile("vehicles.lua")
   -----------------landfillzone SECTION -----------------------------
attractor.landfillzone_attract = 
{
	-- attraction strength from -100 to 100 (negative values repel)
	strength = 60,
	radius = 150,					-- influence radius, in meters
...
occupant_group.landfillzone =   ---- this is the building group name
{
	 group_id = "0x1406",			-- this should be a GUID defined in ingred.ini's "occupant groups" value map - building group number
      --percentage = 0.2,
      controllers = {
         "landfillzone_attract",
         "landfillzone_out",
      },
}
-- verification
