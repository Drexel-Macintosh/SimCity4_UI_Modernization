...
$SRC = @(
    ...
    "IniCache.cpp", "IniCache.h", "IniParse.h", "RoundHalfUp.h", "ExeBase.h",
    "Logger.cpp", "Logger.h",
    ...
    "UiSpike.cpp", "UiSpike.h", "UiSpikeInternal.h", "UiSpikeIds.h", "UiSpikeSelector.cpp", "UiSpikeRegion.cpp", "UiSpikeMinimap.cpp", "UiSpikeFlyouts.cpp",
