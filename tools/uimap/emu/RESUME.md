...
minutes with the stock-park restore script (retired 2026-08-23 in the repo
hygiene sweep; `_tests\Set-StockPlugins.ps1` is the current stock-state tool; procedure in
