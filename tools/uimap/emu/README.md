...
| `measure_lineh_tier.py` | **an instrument, not a model**: given one capture PNG per tier it clears the `lineHeight` unknown at 1.5x and 3x. Procedure: `tools\research\_incoming\lineh-tier-capture-procedure.md` |
