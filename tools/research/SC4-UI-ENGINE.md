...
| **9-slice frame** (`blttype=edge`, `edgeimage=yes`) | `cell = (img->Width()/3, img->Height()/3)`, VA `0x00794100`; corners unstretched, edges stretch only *along* the run | snap to a multiple of **3, and 3 alone** | `upscale\find_nine_slice.py` (#157) |
