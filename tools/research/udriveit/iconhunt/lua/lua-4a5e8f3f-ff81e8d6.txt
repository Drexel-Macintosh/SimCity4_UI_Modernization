...
generator.crowd_sm = 
{
      automata = { "businessperson",},						-- create crowd sims
      count = 1,
      rate =5,										-- ...X times per...
...
occupant_group.crowd_biz = 
{
	group_id = "0x1929",		-- this should be a GUID defined in ingred.ini's "occupant groups" value map - building group number
	controllers = {
		"crowd_sm",
		},
}
