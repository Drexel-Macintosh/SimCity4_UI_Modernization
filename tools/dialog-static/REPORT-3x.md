...
## Package contents (265 entries, 2844405 bytes)
...
- 38 control(s) with 2x art but no `imagerect` (edge-slice frames /
  button state strips -- the engine fits cells to the control area;
  self-adapting, eyeball frame thickness in-game).
- Fonts converted: `GenBodyMedium` x31 -> `0x4a809917` (26 px ini, was 13); `GenButton` x4 -> `0x4a809919` (32 px ini, was 16); `GenHeader` x1 -> `0x4a809916` (36 px ini, was 18).
