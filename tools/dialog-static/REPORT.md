...
## Package contents (265 entries, 2653062 bytes)
...
| `0x856DDBAC / 0x1ABE787D / 0xB971F101` | 2x CLONE of `{1abe787d,ea32f100}` (72x82 px) |
| `0x856DDBAC / 0x46A006B0 / 0x13E14FB7` | 2x IN-PLACE override of `{46a006b0,13e14fb7}` (1050x568 px) |
| `0x856DDBAC / 0x46A006B0 / 0x13F15213` | 2x IN-PLACE override of `{46a006b0,13f15213}` (92x194 px) |
| `0x856DDBAC / 0x46A006B0 / 0x40B25215` | 2x CLONE of `{46a006b0,13f15214}` (92x194 px) |
...
- Root 0x89e1567c id=0x27df05bf: area `(109,151,155,248)` -> `(218,302,310,496)` (46x97 -> 92x194).
...
- `imagerect=` doubled (4):
  - GZWinBMP `(0,0,36,41)` -> `(0,0,72,82)`
  - GZWinBMP `(0,0,46,97)` -> `(0,0,92,194)`
  - GZWinBMP `(0,0,36,41)` -> `(0,0,72,82)`
  - GZWinBMP `(0,0,46,97)` -> `(0,0,92,194)`
...
|---|---|---|---|
| Move In My Sim marker (green+red, #191) | 46x97 at (109,151) | **92x194** at (218,302) |  |
...
### ZCarbonCamUI (`z_SC4UIScale_ZCarbonCamUI.dat`, 10 entries, 151125 bytes)

7 carbon script(s):

- `I-12121201` Civic query panel (CAM-only, 292x260) (carbon): root GZWinGen id=0x10000005, 1x 292x260 -> 2x 584x520
- `I-2a554f6d` Query panel (CAM override, 300x480) (carbon): root GZWinGen id=0x10000005, 1x 300x500 -> 2x 600x1000
- `I-9b868f68` City info screen (CAM-only, 600x525, 116 nodes) (carbon): root GZWinGen id=0x10000005, 1x 608x540 -> 2x 1216x1080
- `I-aa8b999e` Query panel (CAM override, 404x346) (carbon): root GZWinGen id=0x10000005, 1x 404x346 -> 2x 808x692
- `I-ca8b8564` Query panel (CAM override, 292x287 moved) (carbon): root GZWinGen id=0x10000005, 1x 292x287 -> 2x 584x574
- `I-ca8cbf0f` Generic one-button popup (CAM override, 500x175) (carbon): root GZWinGen id=0xaa8def97, 1x 500x175 -> 2x 1000x350
- `I-ea565970` Query panel (CAM override, 304x297) (carbon): root GZWinGen id=0x10000005, 1x 304x297 -> 2x 608x594
...
### ZCarbonSaveWarning (`z_SC4UIScale_ZCarbonSaveWarning.dat`, 2 entries, 8212 bytes)

2 carbon script(s):

- `I-0a55161d` Quit confirm (save-warning override) (carbon): root GZWinGen id=0xaa921f4f, 1x 270x162 -> 2x 540x324
- `I-6a553aa4` Exit to Region confirm (save-warning override) (carbon): root GZWinGen id=0xaa921f4f, 1x 270x162 -> 2x 540x324

### ZCarbonUI (`z_SC4UIScale_ZCarbonUI.dat`, 197 entries, 1367394 bytes)

109 carbon script(s):

- `I-0a243d80` Select A My Sim (Sim-mode sim picker) (carbon): root GZWinGen id=0x6a243d9e, 1x 434x381 -> 2x 868x762
- `I-0a2dd355` Tutorial page (also an HTML-fed pane - see list D) (carbon): root GZWinGen id=0x4a35b0f2, 1x 473x308 -> 2x 946x616
- `I-0a4d0c43` Reconcile Edges (boundaries match) (carbon): root GZWinGen id=0x6a4d0a59, 1x 357x152 -> 2x 714x304
- `I-0a562a05` Query panel 0a562a05 (carbon): root GZWinGen id=0x10000005, 1x 292x120 -> 2x 584x240
- `I-0a5cf71d` Game Over / Run for Senator (carbon): root GZWinGen id=0x2a5cfb2c, 1x 355x218 -> 2x 710x436
- `I-0a7df315` Play Options (carbon): root GZWinGen id=0x2a57db82, 1x 699x523 -> 2x 1398x1046
- `I-0a8b819e` Query panel 0a8b819e (carbon): root GZWinGen id=0x10000005, 1x 292x203 -> 2x 584x406
- `I-0a8b98fe` Query panel 0a8b98fe (carbon): root GZWinGen id=0x10000005, 1x 292x134 -> 2x 584x268
- `I-0a8b9a67` Query panel 0a8b9a67 (carbon): root GZWinGen id=0x10000005, 1x 292x134 -> 2x 584x268
- `I-0a8b9c43` Query panel 0a8b9c43 (carbon): root GZWinGen id=0x10000005, 1x 292x134 -> 2x 584x268
- `I-0a8b9c6a` Query panel 0a8b9c6a (carbon): root GZWinGen id=0x10000005, 1x 292x134 -> 2x 584x268
- `I-0a8cd184` Start New City bubble (carbon): root 0x89e1567c id=0x0a551c50, 1x 216x165 -> 2x 432x330
- `I-0bbc06b6` Advisor toast (blue) (carbon): root GZWinGen id=0xebbc081e, 1x 450x246 -> 2x 900x492
- `I-2a41436b` Establish City (carbon): root GZWinGen id=0x6a414973, 1x 434x234 -> 2x 868x468
- `I-2a41436c` Obliterate City confirm (carbon): root GZWinGen id=0x27df05be, 1x 339x200 -> 2x 678x400
- `I-2a5621ee` Query panel 2a5621ee (carbon): root GZWinGen id=0x10000005, 1x 292x181 -> 2x 584x362
- `I-2a564884` Query panel 2a564884 (carbon): root GZWinGen id=0x10000005, 1x 292x225 -> 2x 584x450
- `I-2a56675c` Query panel 2a56675c (carbon): root GZWinGen id=0x10000005, 1x 292x138 -> 2x 584x276
- `I-2a567dc1` Building query (short variant) (carbon): root GZWinGen id=0x10000005, 1x 292x330 -> 2x 584x660
- `I-2a5e7490` Query panel 2a5e7490 (carbon): root GZWinGen id=0x10000005, 1x 502x213 -> 2x 1004x426
- `I-2a8b7e1c` Query panel 2a8b7e1c (carbon): root GZWinGen id=0x10000005, 1x 292x242 -> 2x 584x484
- `I-2a8b97c1` Query panel 2a8b97c1 (carbon): root GZWinGen id=0x10000005, 1x 292x134 -> 2x 584x268
- `I-2a8b99d0` Query panel 2a8b99d0 (carbon): root GZWinGen id=0x10000005, 1x 292x134 -> 2x 584x268
- `I-2a8b9df2` Query panel 2a8b9df2 (carbon): root GZWinGen id=0x10000005, 1x 292x134 -> 2x 584x268
- `I-2bb16d50` Advisor toast (green) (carbon): root GZWinGen id=0xebb16d71, 1x 450x246 -> 2x 900x492
- `I-2c02ba84` Query panel 2c02ba84 (carbon): root 0x89e1567c id=0x10000006, 1x 216x136 -> 2x 432x272
- `I-2c096de6` Query panel 2c096de6 (carbon): root GZWinGen id=0x10000005, 1x 292x134 -> 2x 584x268
- `I-4a551b4c` Quit confirm (region screen) (carbon): root GZWinGen id=0xaa921f4f, 1x 330x109 -> 2x 660x218
- `I-4a562da5` Query panel 4a562da5 (carbon): root GZWinGen id=0x10000005, 1x 292x205 -> 2x 584x410
- `I-4a565d13` Query panel 4a565d13 (carbon): root GZWinGen id=0x10000005, 1x 292x211 -> 2x 584x422
- `I-4a5665eb` Query panel 4a5665eb (carbon): root GZWinGen id=0x10000005, 1x 292x134 -> 2x 584x268
- `I-4a566c14` Query panel 4a566c14 (carbon): root GZWinGen id=0x10000005, 1x 292x205 -> 2x 584x410
- `I-4a566d6e` Query panel 4a566d6e (carbon): root GZWinGen id=0x10000005, 1x 292x210 -> 2x 584x420
- `I-4a5672bf` Building query (tall variant) (carbon): root GZWinGen id=0x10000005, 1x 292x443 -> 2x 584x886
- `I-4a5a89d4` Advisor toast (salmon) (carbon): root GZWinGen id=0x4a9db60c, 1x 450x246 -> 2x 900x492
- `I-4a5a89d5` Advisor toast (salmon B) (carbon): root GZWinGen id=0x4a9db60c, 1x 528x450 -> 2x 1056x900
- `I-4a5e7ed3` Query panel 4a5e7ed3 (carbon): root GZWinGen id=0x10000005, 1x 502x172 -> 2x 1004x344
- `I-4a89b3f2` Can't-save-during-disaster confirm (carbon): root GZWinGen id=0x2a96ed21, 1x 300x128 -> 2x 600x256
- `I-4a8b7fe7` Query panel 4a8b7fe7 (carbon): root GZWinGen id=0x10000005, 1x 292x242 -> 2x 584x484
- `I-4a8b9396` Query panel 4a8b9396 (carbon): root GZWinGen id=0x10000005, 1x 292x134 -> 2x 584x268
- `I-4a8b9936` Query panel 4a8b9936 (carbon): root GZWinGen id=0x10000005, 1x 292x134 -> 2x 584x268
- `I-4a8b9c92` Query panel 4a8b9c92 (carbon): root GZWinGen id=0x10000005, 1x 292x134 -> 2x 584x268
- `I-4a8b9dab` Query panel 4a8b9dab (carbon): root GZWinGen id=0x10000005, 1x 292x134 -> 2x 584x268
- `I-4a8cc5ea` Photo Album (carbon): root GZWinGen id=0x0a8cd3ee, 1x 683x582 -> 2x 1366x1164
- `I-4bbc080f` Advisor toast (peach) (carbon): root GZWinGen id=0xebbc081e, 1x 450x246 -> 2x 900x492
- `I-4bf325e8` U-Drive-It Select vehicle for <MySim> (carbon): root GZWinGen id=0xcbf32603, 1x 434x447 -> 2x 868x894
- `I-4c0969e2` Query panel 4c0969e2 (carbon): root GZWinGen id=0x10000005, 1x 292x134 -> 2x 584x268
- `I-4c47800e` Query panel 4c47800e (carbon): root GZWinGen id=0x10000005, 1x 292x221 -> 2x 584x442
- `I-6a51506f` Query panel 6a51506f (carbon): root GZWinGen id=0x10000005, 1x 292x210 -> 2x 584x420
- `I-6a555a84` Query panel 6a555a84 (carbon): root GZWinGen id=0x10000005, 1x 292x221 -> 2x 584x442
- `I-6a561b3a` Query panel 6a561b3a (carbon): root GZWinGen id=0x10000005, 1x 292x223 -> 2x 584x446
- `I-6a562f56` Query panel 6a562f56 (carbon): root GZWinGen id=0x10000005, 1x 292x283 -> 2x 584x566
- `I-6a566151` Query panel 6a566151 (carbon): root GZWinGen id=0x10000005, 1x 292x221 -> 2x 584x442
- `I-6a5e73c0` Tutorial exit confirm (carbon): root GZWinGen id=0xea5e748c, 1x 330x113 -> 2x 660x226
- `I-6a8b9875` Query panel 6a8b9875 (carbon): root GZWinGen id=0x10000005, 1x 292x134 -> 2x 584x268
- `I-6a8b9acc` Query panel 6a8b9acc (carbon): root GZWinGen id=0x10000005, 1x 292x134 -> 2x 584x268
- `I-6a8b9af3` Query panel 6a8b9af3 (carbon): root GZWinGen id=0x10000005, 1x 292x134 -> 2x 584x268
- `I-6b704690` Label Tool (map annotation) (carbon): root GZWinGen id=0x8a8dfcf5, 1x 409x142 -> 2x 818x284
- `I-8a4d0a17` Reconcile Edges (variant 3) (carbon): root GZWinGen id=0x6a4d0a59, 1x 357x182 -> 2x 714x364
- `I-8a554483` Query panel 8a554483 (carbon): root GZWinGen id=0x10000005, 1x 292x274 -> 2x 584x548
- `I-8a5ab1cb` Region Name (Create Region) (carbon): root GZWinGen id=0xea5ba0d1, 1x 330x168 -> 2x 660x336
- `I-8a5ab1cc` Load Region (carbon): root GZWinGen id=0x4a5ba0e7, 1x 330x188 -> 2x 660x376
- `I-8a5ab1cd` City Import (carbon): root GZWinGen id=0x0a5ba192, 1x 330x188 -> 2x 660x376
- `I-8a5ab1ce` Delete Region confirm (carbon): root GZWinGen id=0x6a5ba20c, 1x 300x158 -> 2x 600x316
- `I-8a5ab1cf` Quit confirm (are-you-sure) (carbon): root GZWinGen id=(no id), 1x 313x128 -> 2x 626x256
- `I-8a5ab1d0` Delete City confirm (carbon): root GZWinGen id=0x8a5ab1d0, 1x 302x128 -> 2x 604x256
- `I-8a5e7bd2` Query panel 8a5e7bd2 (carbon): root GZWinGen id=0x10000005, 1x 502x213 -> 2x 1004x426
- `I-8a7e052f` Graphic Options (carbon): root GZWinGen id=0x2a57cb82, 1x 722x558 -> 2x 1444x1116
- `I-8a8b95b0` Query panel 8a8b95b0 (carbon): root GZWinGen id=0x10000005, 1x 292x134 -> 2x 584x268
- `I-8a8b9811` Query panel 8a8b9811 (carbon): root GZWinGen id=0x10000005, 1x 292x134 -> 2x 584x268
- `I-8a8b98a7` Query panel 8a8b98a7 (carbon): root GZWinGen id=0x10000005, 1x 292x134 -> 2x 584x268
- `I-8a8b9d12` Query panel 8a8b9d12 (carbon): root GZWinGen id=0x10000005, 1x 292x134 -> 2x 584x268
- `I-8a948d49` Query panel 8a948d49 (carbon): root GZWinGen id=0x10000005, 1x 292x144 -> 2x 584x288
- `I-aa554aea` Query panel aa554aea (carbon): root GZWinGen id=0x10000005, 1x 292x229 -> 2x 584x458
- `I-aa555346` Query panel aa555346 (carbon): root GZWinGen id=0x10000005, 1x 292x182 -> 2x 584x364
- `I-aa561f93` Query panel aa561f93 (carbon): root GZWinGen id=0x10000005, 1x 292x160 -> 2x 584x320
- `I-aa565036` Query panel aa565036 (carbon): root GZWinGen id=0x10000005, 1x 292x210 -> 2x 584x420
- `I-aa565f5b` Query panel aa565f5b (carbon): root GZWinGen id=0x10000005, 1x 292x134 -> 2x 584x268
- `I-aa5661eb` Query panel aa5661eb (carbon): root GZWinGen id=0x10000005, 1x 292x211 -> 2x 584x422
- `I-aa5bef41` Query panel aa5bef41 (carbon): root GZWinGen id=0x10000005, 1x 292x165 -> 2x 584x330
- `I-aa5e14cc` Query panel aa5e14cc (carbon): root GZWinGen id=0x10000005, 1x 502x214 -> 2x 1004x428
- `I-aa5e60d1` Clock time popup (carbon): root GZWinGen id=0xca5e6261, 1x 92x30 -> 2x 184x60
- `I-aa8b9755` Query panel aa8b9755 (carbon): root GZWinGen id=0x10000005, 1x 292x134 -> 2x 584x268
- `I-aa8b9971` Query panel aa8b9971 (carbon): root GZWinGen id=0x10000005, 1x 292x134 -> 2x 584x268
- `I-abfaef15` U-Drive-It Select pedestrian style (carbon): root GZWinGen id=0xcbf32603, 1x 434x299 -> 2x 868x598
- `I-ac096ac7` Query panel ac096ac7 (carbon): root GZWinGen id=0x10000005, 1x 292x134 -> 2x 584x268
- `I-ac3b72f6` Query panel ac3b72f6 (carbon): root GZWinGen id=0x10000005, 1x 292x221 -> 2x 584x442
- `I-ca4d0b22` Reconcile Edges (highlighted areas confirm) (carbon): root GZWinGen id=0x6a4d0a59, 1x 357x157 -> 2x 714x314
- `I-ca539340` Existing-city bubble (carbon): root 0x89e1567c id=0x0a551c50, 1x 258x250 -> 2x 516x500
- `I-ca53f06e` Audio Options (carbon): root GZWinGen id=0xea53f5db, 1x 330x471 -> 2x 660x942
- `I-ca551016` Credits (carbon): root GZWinGen id=0x0a592004, 1x 525x284 -> 2x 1050x568
- `I-ca566f94` Query panel ca566f94 (carbon): root GZWinGen id=0x10000005, 1x 292x230 -> 2x 584x460
- `I-ca56783a` Building query (residential) (carbon): root GZWinGen id=0x10000005, 1x 292x334 -> 2x 584x668
- `I-ca8b8408` Query panel ca8b8408 (carbon): root GZWinGen id=0x10000005, 1x 292x252 -> 2x 584x504
- `I-ca8b96c2` Query panel ca8b96c2 (carbon): root GZWinGen id=0x10000005, 1x 292x134 -> 2x 584x268
- `I-ca8b9845` Query panel ca8b9845 (carbon): root GZWinGen id=0x10000005, 1x 292x134 -> 2x 584x268
- `I-ca8b9aa2` Query panel ca8b9aa2 (carbon): root GZWinGen id=0x10000005, 1x 292x134 -> 2x 584x268
- `I-ca8b9ce7` Query panel ca8b9ce7 (carbon): root GZWinGen id=0x10000005, 1x 292x134 -> 2x 584x268
- `I-ca8b9d40` Query panel ca8b9d40 (carbon): root GZWinGen id=0x10000005, 1x 292x134 -> 2x 584x268
- `I-cc097fc0` Query panel cc097fc0 (carbon): root GZWinGen id=0x10000005, 1x 292x134 -> 2x 584x268
- `I-cc313f17` Query panel cc313f17 (carbon): root GZWinGen id=0x10000005, 1x 292x193 -> 2x 584x386
- `I-ea5655e4` Query panel ea5655e4 (carbon): root GZWinGen id=0x10000005, 1x 292x283 -> 2x 584x566
- `I-ea566a49` Query panel ea566a49 (carbon): root GZWinGen id=0x10000005, 1x 292x172 -> 2x 584x344
- `I-ea89b6c3` Missing plugin-packs warning (city load) (carbon): root GZWinGen id=0x2a5cfb2c, 1x 355x238 -> 2x 710x476
- `I-ea8b82db` Query panel ea8b82db (carbon): root GZWinGen id=0x10000005, 1x 292x255 -> 2x 584x510
- `I-ea8cc3c6` Generic message box (code-driven confirms) (carbon): root GZWinGen id=0x8a8dfcf5, 1x 364x192 -> 2x 728x384
- `I-eaaeec1b` Exit to Region (in-city, play-city variant) (carbon): root GZWinGen id=0x6aaeec4a, 1x 330x157 -> 2x 660x314
- `I-ebd0d36c` Select A Bridge (network across water) (carbon): root GZWinGen id=0x0c525b9e, 1x 411x373 -> 2x 822x746
- `I-ec096e72` Query panel ec096e72 (carbon): root GZWinGen id=0x10000005, 1x 292x134 -> 2x 584x268
